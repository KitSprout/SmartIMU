...
#define SPIx_INT_PIN                GPIO_PIN_3
#define SPIx_INT_GPIO_PORT          GPIOA
#define SPIx_INT_GPIO_CLK_ENABLE()  __HAL_RCC_GPIOA_CLK_ENABLE()
#define SPIx_INT_IRQ                EXTI3_IRQn
...
void MPU9250_GPIO_Config( void )
{
  ...
  HAL_NVIC_SetPriority(SPIx_INT_IRQ, 14, 0);
  HAL_NVIC_EnableIRQ(SPIx_INT_IRQ);
}
/*====================================================================================================*/
/*====================================================================================================*
...
uint8_t MPU9250_Init( MPU_InitTypeDef *MPUx )
{
  ...
  uint8_t MPU6500_InitData[MPU6500_InitRegNum][2] = {
    ...
    {0x18, MPU6500_GYRO_CONFIG},    // default : +-2000dps
    {0x08, MPU6500_ACCEL_CONFIG},   // default : +-4G
    {0x07, MPU6500_CONFIG},         // default : LPS_41Hz
    {0x03, MPU6500_ACCEL_CONFIG_2}, // default : LPS_41Hz
