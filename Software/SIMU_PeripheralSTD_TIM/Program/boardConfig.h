...
/* -------- TIM Timer */
#define TIMER2                        TIM2
#define TIMER2_CLK_ENABLE()           RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM2, ENABLE)
#define TIMER2_IRQn                   TIM2_IRQn
#define TIMER2_IRQn_PREEMPT           0x000F
#define TIMER2_IRQn_SUB               0x0000

#define TIMER3                        TIM3
#define TIMER3_CLK_ENABLE()           RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM3, ENABLE)
#define TIMER3_IRQn                   TIM3_IRQn
#define TIMER3_IRQn_PREEMPT           0x000F
#define TIMER3_IRQn_SUB               0x0000

#define TIMER4                        TIM4
#define TIMER4_CLK_ENABLE()           RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM4, ENABLE)
#define TIMER4_IRQn                   TIM4_IRQn
#define TIMER4_IRQn_PREEMPT           0x000F
#define TIMER4_IRQn_SUB               0x0000
