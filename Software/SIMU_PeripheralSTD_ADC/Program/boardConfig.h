...
/* -------- ADC Battery */
#define BAT_MAX_CONVBUF               8

#define BAT_ADCx                      ADC1
#define BAT_ADCx_CLK_ENABLE()         RCC_APB2PeriphClockCmd(RCC_APB2Periph_ADC1, ENABLE)
#define BAT_DMAx_CLK_ENABLE()         RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_DMA2, ENABLE)

#define BAT_ADCx_RANK                 1
#define BAT_ADCx_SAMPLECYCLES         ADC_SampleTime_480Cycles
#define BAT_ADCx_CHANNEL              ADC_Channel_9
#define BAT_ADCx_CHANNEL_PIN          GPIO_Pin_1
#define BAT_ADCx_CHANNEL_PORT         GPIOB
