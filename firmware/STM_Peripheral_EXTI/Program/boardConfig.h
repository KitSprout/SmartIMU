...
#define LK_STATE_PIN                    GPIO_PIN_9
#define LK_STATE_GPIO_PORT              GPIOA
#define LK_STATE_Read()                 (__GPIO_READ(LK_STATE_GPIO_PORT, LK_STATE_PIN) == LK_STATE_PIN)
#define LK_STATE_EXTIx_IRQ              EXTI9_5_IRQn
#define LK_STATE_EXTIx_IRQn_PREEMPT     0x0F
#define LK_STATE_EXTIx_IRQn_SUB         1
